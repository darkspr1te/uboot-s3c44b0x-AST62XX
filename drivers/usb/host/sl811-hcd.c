...
* darkspr1te */
/* trl is at 6
 * tried 0x8000000 and it see's 1 hub no device
 * tried 0x6000000 and it see's 1 device
 * tried 0xa000000 and it see's 2 hub no device. setup failed
 * tried 0x2000000 and it see's 2 hub no device. setup failed
 * tried 0x4000000 and it see's 1 hub no device. setup failed on second run
 * */
